...
// domain mapping) — redirect browser traffic to the canonical Vercel deployment so the
...
const CANONICAL_HOST = "frontend-5dx8augyq-igenov-4615s-projects.vercel.app";
